...
export function VendorSidebar({ 
  ...
  return (
    <>
      ...
      {/* Sidebar/Drawer */}
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-[#26292C] text-white flex flex-col transition-transform duration-300 ease-in-out ${
          isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
        } h-[100dvh] pb-safe`}
      >
        <div className="flex items-center justify-between h-16 px-6 bg-white shrink-0 border-b border-gray-200">
          <span className="text-xl font-extrabold text-[#FC6B31] tracking-tight">
            Vendor Portal
          </span>
          <button onClick={onClose} className="lg:hidden text-gray-500 p-2">
            <X className="w-6 h-6" />
          </button>
        </div>
        ...
        <div className="py-4 space-y-1 shrink-0 mb-16 lg:mb-0">
          <ul className="space-y-1">
            ...
            <li>
              ...
              >
                <LogOut className="w-5 h-5 shrink-0 mr-4" />
      ...
      {showLogoutModal && (
        <div className="fixed inset-0 bg-black/50 z-[60] flex items-center justify-center p-4">
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-sm p-6 text-center animate-in zoom-in-95 duration-200">
            ...
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Do you want to logout?</h3>
            <p className="text-gray-500 dark:text-gray-400 mb-6">You will need to sign in again to access your store.</p>
