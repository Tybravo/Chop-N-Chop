    ...
    <div className="bg-secondary-light/5 min-h-screen py-10 px-4">
      <div className="container mx-auto max-w-4xl">
        ...
        {MOCK_ORDERS.length === 0 ? (
          <div className="bg-white dark:bg-gray-900 p-12 rounded-3xl shadow-xl overflow-hidden border border-[#fd8b5d] dark:border-[#e35014] transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-orange dark:hover:shadow-[0_0_25px_rgba(252,107,49,0.6)] text-center">
          ...
          <div className="space-y-6">
            {MOCK_ORDERS.map((order) => (
              <div 
                key={order.id} 
                className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl overflow-hidden border border-[#fd8b5d] dark:border-[#e35014] transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-orange dark:hover:shadow-[0_0_25px_rgba(252,107,49,0.6)]"
              >
